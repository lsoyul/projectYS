...
namespace LDG.SoundReactor
{
    ...
    public class ColorDriver : PropertyDriver
    {
        ...
        private void ColorsToGradient(Color[] colors)
        {
            ...
            mainColor.SetKeys(colorKeys, alphaKeys);
        }

        public void SetColorSpectrum()
        {
            ColorsToGradient(new Color[] { Color.red, new Color(1.0f, 0.5f, 0.0f), Color.yellow, Color.green, Color.cyan, Color.blue, Color.magenta });
        }

        public void SetColorDefault()
        {
            ColorsToGradient(new Color[] { new Color(0.1f, 0.1f, 0.1f), new Color(1.0f, 0.5f, 0.0f) });
        }
